...
function Projects() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#181b47] via-[#081425] to-[#181b47] mb-20 py-40 px-2 sm:px-10 cursor-default ">
      <div className="flex flex-col items-center justify-center py-10 px-5 gap-4 animate-fadeIn">
        <h1 className="text-4xl md:text-6xl font-bold text-[#fff] tracking-wide">
          My Work
        </h1>
        <p className="text-gray-400 text-sm sm:text-lg text-center max-w-2xl">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none rotate-180">
        ...
        >
          <path
            ...
            className="fill-[#0A001B]"
          ></path>
        </svg>
      </div>

      <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-20 animate-fadeIn">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-[#F1F4F9] rounded-3xl overflow-hidden hover:scale-95 duration-500"
          >
            <div
            ...
            <div className="p-4 flex flex-col justify-between h-40">
              <h2 className="text-xl font-bold text-[#0A001B] mb-2 truncate text-center">
                {project.title}
              </h2>
      ...
      <div className="flex items-center justify-center py-10 animate-fadeIn">
        <p className="text-lg sm:text-xl md:text-4xl font-medium text-gray-100 text-center animate-pulse glow">
